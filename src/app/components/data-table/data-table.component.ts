...
@Component({
  ...
  template: `
    <div class="overflow-x-auto rounded-lg border border-gray-200 shadow-sm">
      <!-- Loading overlay -->
      <div *ngIf="loading" class="flex items-center justify-center py-16 text-gray-500 text-sm">
      ...
      <!-- Table -->
      <table *ngIf="!loading" class="min-w-full divide-y divide-gray-200 text-sm">
        ...
        <tbody class="bg-white divide-y divide-gray-100">
          <tr *ngIf="rows.length === 0">
            <td [colSpan]="columns.length + 1" class="px-4 py-10 text-center text-gray-400 text-sm">
              No records found.
            </td>
          </tr>
